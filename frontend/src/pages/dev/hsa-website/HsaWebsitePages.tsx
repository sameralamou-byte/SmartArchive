  ...
  return (
    <main>
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <p className="text-overline font-bold uppercase tracking-wide text-accent-2">Security &amp; Privacy</p>
        <h1 className="mt-2 max-w-xl font-display text-display-l font-bold text-[color:var(--esa-surface)]">
          Your documents. Protected by design.
        </h1>
        <p className="mt-4 max-w-xl text-body-l text-text-secondary">
          Privacy, control, and a clear record of what SmartArchive suggested. No invented certifications or encryption
          claims in this preview.
        </p>
        ...
        <Button type="button" variant="primary" className="mt-8" onClick={() => navigate("/register")}>
          Start for free
        </Button>
      </section>
    </main>
